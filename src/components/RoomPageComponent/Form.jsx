  ...
  return (
    <div
      className={`overflow-hidden transition-all duration-500 ease-in-out border-gray-200 ${
        isOpen ? "max-h-[1000px] opacity-100 border-b bg-white" : "max-h-0 opacity-0 border-b-0"
      }`}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="flex items-start justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm text-gray-500">Launch a new space for your team.</p>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10">
          ...
          <div className="space-y-5">
            <div>
              <label className="block text-sm font-bold text-gray-700 mb-2 ml-1">Room Name</label>
          ...
          {/* Right Column: Info & Action (Aligned to bottom) */}
          <div className="flex flex-col justify-between pt-1 lg:pt-7">
            <div className="bg-blue-50/50 border border-blue-100 p-5 rounded-2xl mb-6 lg:mb-0">
              <div className="flex gap-3 text-blue-800">
                ...
                <div>
                  ...
                  <p className="text-xs opacity-80 mt-1">You will be the admin of this room. You can invite members via the dashboard after creation.</p>
                </div>
              </div>
            </div>
            ...
            <button
              type="submit"
              className="w-full py-4 bg-blue-600 text-white rounded-2xl font-bold hover:bg-blue-700 shadow-xl shadow-blue-200 transition-all flex items-center justify-center gap-3 active:scale-[0.98]"
            >
              <Send className="w-5 h-5" /> 
              <span>Confirm & Create Room</span>
            </button>
          </div>
        </form>
      </div>
